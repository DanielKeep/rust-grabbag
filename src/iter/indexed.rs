...
impl<It, IndIt, E> Iterator for Indexed<It, IndIt> where It: RandomAccessIterator<Item=E>, IndIt: Iterator<Item=uint> {
    type Item = Option<E>;
...
impl<It, IndIt, E> DoubleEndedIterator for Indexed<It, IndIt> where It: RandomAccessIterator<Item=E>, IndIt: DoubleEndedIterator<Item=uint> {
    fn next_back(&mut self) -> Option<Option<E>> {
        self.indices.next_back().map(|e| self.iter.idx(e))
    }
}

impl<It, IndIt, E> RandomAccessIterator for Indexed<It, IndIt> where It: RandomAccessIterator<Item=E>, IndIt: RandomAccessIterator<Item=uint> {
...
impl<'a, It, IndIt, E> Iterator for IndexedView<'a, It, IndIt> where It: 'a + RandomAccessIterator<Item=E>, IndIt: Iterator<Item=uint> {
    type Item = Option<E>;
...
impl<'a, It, IndIt, E> DoubleEndedIterator for IndexedView<'a, It, IndIt> where It: 'a + RandomAccessIterator<Item=E>, IndIt: DoubleEndedIterator<Item=uint> {
    fn next_back(&mut self) -> Option<Option<E>> {
        self.indices.next_back().map(|e| self.iter.idx(e))
    }
}

impl<'a, It, IndIt, E> RandomAccessIterator for IndexedView<'a, It, IndIt> where It: 'a + RandomAccessIterator<Item=E>, IndIt: RandomAccessIterator<Item=uint> {
    fn indexable(&self) -> uint {
        self.indices.indexable()
    }
